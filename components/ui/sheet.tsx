...
import useCartModal from "@/hooks/useCartModal"; // Still import the hook
...
>(({ side = "left", className, children, ...props }, ref) => {
  const cartModal = useCartModal(); // Move the hook call inside the component body
