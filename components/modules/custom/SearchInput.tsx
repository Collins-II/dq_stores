...
export default function SearchInput() {
  ...
  return (
    <div className={cn("hidden relative w-full group", "xl:block")}>
      <div className="relative border border-white bg-neutral-200 flex-1 hidden lg:flex group-hover:bg-neutral-50 group-hover:shadow-xl rounded-full">
        <Input
        ...
        />
        <CiSearch size={28} className="absolute right-4 top-4 text-white"/>
      </div>
